  ...
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        <img src={ assets.sample_img_1 } alt="smpl img1" className='
        w-80 xl:w-96 rounded-lg
        '/>
        <div>
          <h2 className='text-3xl font-medium max-w-lg mb-4 '>Introducing the AI-powered Text to Image Generator</h2>

          <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator. Whether you need stunning visuals or unique
          ...
          <p className='text-gray-600 mb-4'>
            ...
            visuals to character designs and potraits, even concepts that don't yet exist can be visualized effortlessly.
